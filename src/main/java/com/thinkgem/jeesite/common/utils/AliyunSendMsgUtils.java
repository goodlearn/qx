...
public class AliyunSendMsgUtils {
	...
	public static boolean sendMsg(String phoneNumber,Map<String,String> map,int type) {
		...
		try {
			...
			if(type == 0) {
				...
				request.setTemplateCode(DictUtils.getDictValue("ALIYUN_MSG_TEMPLATE_NAME_2", "systemControl", ""));
			}
