...
/**
 * 108T卡车1000小时保养单(机械部分)Service
 * @author wzy
 * @version 2018-02-28
 */
@Service
@Transactional(readOnly = true)
public class Item108t1000ByService extends CrudService<Item108t1000ByDao, Item108t1000By> {
	...
	public void createMask(ViewMcsi1[] viewMcsi1s,User user) {
		...
		for(ViewMcsi1 viewMsci1 : viewMcsi1s) {
			...
			Item108t1000By queryMcsi1 = new Item108t1000By();
			queryMcsi1.setPart(part);
			queryMcsi1.setAssembleId(bussinessAssembleId);
			List<Item108t1000By> mcsi1List = dao.findList(queryMcsi1);
			...
			for(Item108t1000By forEntity :mcsi1List) {
				//每个人关联的任务保存
	...
	public Item108t1000By get(String id) {
		return super.get(id);
	}
	
	public List<Item108t1000By> findList(Item108t1000By item108t1000By) {
		return super.findList(item108t1000By);
	}
	
	public Page<Item108t1000By> findPage(Page<Item108t1000By> page, Item108t1000By item108t1000By) {
		return super.findPage(page, item108t1000By);
	}
	
	@Transactional(readOnly = false)
	public void save(Item108t1000By item108t1000By) {
		super.save(item108t1000By);
	}
	
	@Transactional(readOnly = false)
	public void delete(Item108t1000By item108t1000By) {
		super.delete(item108t1000By);
	}
