...
/**
 * 108T卡车660小时保养单(机械部分)Service
 * @author wzy
 * @version 2018-02-28
 */
@Service
@Transactional(readOnly = true)
public class Item108t660ByService extends CrudService<Item108t660ByDao, Item108t660By> {
	...
	public void createMask(ViewMcsi1[] viewMcsi1s,User user) {
		...
		//字典数据检验
		if(!type.equals(DictUtils.getDictValue(Global.ITEM_108T_660_BY, "bussinessType", "1"))) {
		...
		for(ViewMcsi1 viewMsci1 : viewMcsi1s) {
			...
			Item108t660By queryMcsi1 = new Item108t660By();
			queryMcsi1.setPart(part);
			queryMcsi1.setAssembleId(bussinessAssembleId);
			List<Item108t660By> mcsi1List = dao.findList(queryMcsi1);
			...
			for(Item108t660By forEntity :mcsi1List) {
				//每个人关联的任务保存
	...
	public Item108t660By get(String id) {
		return super.get(id);
	}
	
	public List<Item108t660By> findList(Item108t660By item108t660By) {
		return super.findList(item108t660By);
	}
	
	public Page<Item108t660By> findPage(Page<Item108t660By> page, Item108t660By item108t660By) {
		return super.findPage(page, item108t660By);
	}
	
	@Transactional(readOnly = false)
	public void save(Item108t660By item108t660By) {
		super.save(item108t660By);
	}
	
	@Transactional(readOnly = false)
	public void delete(Item108t660By item108t660By) {
		super.delete(item108t660By);
	}
