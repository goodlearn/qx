...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sys/sysWxUserCheck/">信信息检查表列表</a></li>
		<shiro:hasPermission name="sys:sysWxUserCheck:edit"><li><a href="${ctx}/sys/sysWxUserCheck/form">信信息检查表添加</a></li></shiro:hasPermission>
	</ul>
