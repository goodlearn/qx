...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/workShopMask/">车间任务数据列表</a></li>
		<li class="active"><a href="${ctx}/sys/workShopMask/form?id=${workShopMask.id}">车间任务数据<shiro:hasPermission name="sys:workShopMask:edit">${not empty workShopMask.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:workShopMask:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="workShopMask" action="${ctx}/sys/workShopMask/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">车间号：</label>
			<div class="controls">
				<form:select path="workShopId" class="input-xlarge required">
					<form:option value="" label=""/>
		...
		<div class="control-group">
			<label class="control-label">部门号：</label>
			<div class="controls">
				<form:select path="workDepartment" class="input-xlarge required">
					<form:option value="" label=""/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:workShopMask:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
