		...
		<c:forEach items="${page.list}" var="workShopMask">
			<tr>
				...
				<shiro:hasPermission name="sys:workShopMask:edit"><td>
    				<a href="${ctx}/sys/workShopMask/form?id=${workShopMask.id}">修改</a>
					<a href="${ctx}/sys/workShopMask/delete?id=${workShopMask.id}" onclick="return confirmx('确认要删除该车间任务数据吗？', this.href)">删除</a>
