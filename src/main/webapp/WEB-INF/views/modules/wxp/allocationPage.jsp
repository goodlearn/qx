	...
	<form id="taksPubSubmit" method="POST" action="allocation">
		<c:if test = "${not empty monthMaskWs}">
			<c:if test = "${not empty monthMaskWc}">
				...
				<input id="monthMaskWsId" type="hidden" name="monthMaskWsId" value="${monthMaskWs.id}" />
				<div class="taskInfo">
					<ul>
						<li class="borderButtom"><p class="taskType">${monthMaskWs.maskDesc}</p></li>
					</ul>
				</div>
				<div class="taskInfo">
					<ul>
