...
<body>
	<ul class="nav nav-tabs">
		<li class="active">车间任务数据列表</li>
	</ul>
	<form:form id="searchForm" modelAttribute="workShopMask" action="${ctx}/sys/wsMaskWc/wsmlist" method="post" class="breadcrumb form-search">
		...
		<c:forEach items="${page.list}" var="workShopMask">
			<tr>
				...
				<shiro:hasPermission name="sys:wsMaskWc:edit"><td>
				    <a href="${ctx}/sys/wsMaskWc/releasePd?wsmId=${workShopMask.id}">每日发布</a>
